...
export class DashboardComponent implements OnInit {
  ...
  //constructor(public http: Http,private dashboardService:DashboardService ) {
  ...
  newCustomerLis(){
    // console.log("R M Service :::==== "+this.dashboardService.getRMCustomer().subscribe(data=>{

    //   //this.customerdto=data;
    //   console.log( "From DATA :::::"+this.customerdto);
    // }));
  }
